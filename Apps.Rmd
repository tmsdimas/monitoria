...
dados$Data_Visita2      <- as.Date(dados$Data_Visita2, format = "%d-%m-%Y")
dados$Data_Colheita      <- as.Date(dados$Data_Colheita, format = "%d-%m-%Y")
dados$DataVisita3      <- as.Date(dados$DataVisita3, format = "%d-%m-%Y")
dados$Data_Recepção_Resultado      <- as.Date(dados$Data_Recepção_Resultado, format = "%d-%m-%Y")
dados$Data_Entrega_Resultado     <- as.Date(dados$Data_Entrega_Resultado, format = "%d-%m-%Y")


#------------------ Limpeza e Processamento dos Dados Gerais ------------------


## Diferença entre os dias da Primeira a terceira visita,adição de mais duas colunas
...
renderValueBox({
  valueBox(value = paste(format(total_casos$total, big.mark = ","), "", sep = " "),
         caption = "Total de Casos Indeterminados", 
...
renderValueBox({
  valueBox(value = paste(format(total_casos$`CS Amílcar Cabral`, big.mark = ","), " (",
         ...
         caption = "Total de Casos CS Amílcar Cabral", 
         icon = "far fa-flag", 
         color = bloco4_csamilcar)
})
```
...
renderValueBox({
  valueBox(value = paste(format(total_casos$`CS de lumbo`, big.mark = ","), " (",
         ...
         caption = "Total de Casos CS Lumbo", 
         icon = "fa-solid fa-house-chimney-medical", 
         color = bloco2_cslumbo)
})
```
...
renderValueBox({
  valueBox(value = paste(format(total_casos$`CS de Milange`, big.mark = ","), " (",
         ...
         caption = "Total de Casos CS Milange", 
         icon = "fa-solid fa-house-chimney-medical",  
         color = bloco3_csmilange)
})
```
